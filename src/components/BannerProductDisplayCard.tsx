...
const BannerProductDisplayCard: React.FC<BannerProductDisplayCardProps> = ({
    ...
    return (
        <div className="inline-flex flex-none flex-col bg-slate-100 md:w-80 lg:w-96 w-60 h-full m-2 p-3 rounded-md">
            ...
            <div className="relative flex-grow mb-3">
                ...
                <button className="absolute bottom-2 right-2 text-secondary text-3xl transform hover:scale-110 transition-transform ease-in-out duration-200">
                    <AiOutlinePlusCircle />
                </button>
            </div>
        </div>
